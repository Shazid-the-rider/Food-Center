...
public class productupload extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            public void onClick(View v) {
                ...
                if(q.isEmpty()){
                    ...
                    db.child("item").setValue(container).addOnCompleteListener(task -> {
                        ...
                        {
                            Toast.makeText(productupload.this, "Uploaded Successful", Toast.LENGTH_SHORT).show();
                        }
                        else{
                            Toast.makeText(productupload.this, "Unsuccessful", Toast.LENGTH_SHORT).show();
                        }
        ...
        x.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(productupload.this, admin_home.class));
            }
        });
        ...
        if(imageuri!=null)
        {
            ...
            filereference.putFile(imageuri). addOnSuccessListener(taskSnapshot -> {
                      filereference.getDownloadUrl().addOnSuccessListener(uri -> {
                          ...
                          Toast.makeText(productupload.this, "Image Uploaded Successfully", Toast.LENGTH_SHORT).show();
                      }).addOnFailureListener(e -> {
                          Toast.makeText(productupload.this, "Failed to get Download URL: " + e.getMessage(), Toast.LENGTH_SHORT).show();
                      });
            }).addOnFailureListener(e -> {
                Toast.makeText(productupload.this, "Image Upload Failed: " + e.getMessage(), Toast.LENGTH_SHORT).show();
            });
        }
    }
